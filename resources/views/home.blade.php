...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.html"><i class="fa fa-sun-o"></i> Four-R<strong></strong></a> </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#home" class="page-scroll">Home</a></li>
        <li><a href="#services-section" class="page-scroll">Product</a></li>
        <li><a href="#works-section" class="page-scroll">Portfolio</a></li>
        <li><a href="#about-section" class="page-scroll">About</a></li>
        <li><a href="#team-section" class="page-scroll">Team</a></li>
        <li><a href="#team-section" class="page-scroll">WhitePaper</a></li>
...
<header class="text-center" name="home">
  <div class="intro-text">
    <h1>Welcome to <strong>Four-R</strong></h1>
    <p>We are disrupting the renewable energy with power of coin</p>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-sm-3">
        <div class="achievement-box"> <span class="count">2.1</span>
          <h4>Billion Kgs of Waste Consumed</h4>
        </div>
      </div>
      <div class="col-md-3 col-sm-3">
      ...
      <div class="col-md-3 col-sm-3">
        <div class="achievement-box"> <span class="count">100,000,00</span>
          <h4>Four-R Coins</h4>
        </div>
      </div>
      <div class="col-md-3 col-sm-3">
        <div class="achievement-box"> <span class="count">14.8</span>
          <h4>Billion Kw Energy</h4>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div id="row">
      <div class="col-md-3 col-sm-6 team">
        <div class="thumbnail"> <img src="img/team/2man.png" alt="..." class="img-circle team-img">
          <div class="caption">
            <h3>Anuj Chopra</h3>
            <p>Founder / CEO</p>
            <p>Machine Learning Blockchain Geek</p>
          </div>
        </div>
      </div>
      <div class="col-md-3 col-sm-6 team">
        <div class="thumbnail"> <img src="img/team/3man.png" alt="..." class="img-circle team-img">
          <div class="caption">
            <h3>Nitesh Kumar</h3>
            <p>Founder</p>
...
<div id="footer">
  <div class="container">
    <div class="fnav">
      <p>Copyright &copy; FourR. Designed by FourR</a></p>
    </div>
  </div>
</div>
